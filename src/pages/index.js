          ...
          <div className="flex flex-row flex-wrap">
            ...
            <div className="flex-1 ml-3 mt-3 md:mt-0">
              ...
              <div className="mt-3 text-xs text-gray-600">
                <div> <span className="mt-5 text-xs text-gray-600">Address:</span> Guangzhou Higher Education Mega Center, Guangzhou 510006 P.R.China</div> | <span className="font-bold">Email:</span> yanpang@gzhu.edu.cn</div>
              </div>
            </div>
          </div>
