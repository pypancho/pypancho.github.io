        ...
        <div className="max-w-screen-md max-w-screen-lg mx-auto px-5 py-16 md:pt-28">
          <div className="flex flex-row flex-wrap">
            ...
            <div className="flex-1 ml-3 mt-3 md:mt-0 text-justify">
              <p className="mt-3">
              <b><a className="text-blue-600 text-sm" href={"https://ieeexplore.ieee.org/author/618297131885223"} target="_blank">IEEE Senior Member</a></b>, <b>Associate Professor</b> at the <b>Shenzhen Institutes of Advanced Technology, Chinese Academy of Sciences</b>, China. </p>
          ...
          <div id="news">
            ...
            <div className="text-sm pl-10 py-3 text-justify">
              <ul className="list-disc">
                ...
                <li>[Feb 14, 2026] <b>NEW:</b> One paper has been published in the Expert Systems with Applications. (IF: 9.4).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/OCTMamba" target="_blank">Code</a> is released.</li>
