...
const links = [
    {
    author: <div> Jiahui Huang, Xin Lei, Qiong Wang, Valentin Sinitsyn, Yun Zhu, Ying Hu, Hao Chen, <span className="font-bold">Yan Pang*</span></div>,
    ...
    paper: "https://doi.org/10.1016/j.eswa.2026.133453",
    },
    {
    ...
    <main style={pageStyles}>
      ...
      <div>
        <div className="max-w-screen-md max-w-screen-lg mx-auto px-5 py-16 md:pt-28">
          <div className="flex flex-row flex-wrap">
            ...
            <div className="flex-1 ml-3 mt-3 md:mt-0 text-justify">
              <p className="mt-3">
              <b><a className="text-blue-600 text-sm" href={"https://ieeexplore.ieee.org/author/618297131885223"} target="_blank">IEEE Senior Member</a></b>, <b><a className="text-blue-600 text-sm" href={"https://people.ucas.edu.cn/~pangyan"} target="_blank">Associate Professor</a></b> at the <b>Shenzhen Institutes of Advanced Technology, Chinese Academy of Sciences</b>, China. </p>
          ...
          <div id="news">
            ...
            <div className="text-sm pl-10 py-3 text-justify">
              <ul className="list-disc">
                ...
                <li>[Aug 25, 2025] One paper has been published in the IEEE Transactions on Medical Imaging. (IF: 12.4).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/Slim-UNETRV2" target="_blank">Code</a> is released.</li>
                ...
                <li>[Jul 30, 2025] One paper has been published in the IEEE Transactions on Big Data. (IF: 8.1).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/Consense" target="_blank">Code</a> is released.</li>
                <li>[Jul 14, 2025] One paper has been published in the IEEE Transactions on Information Forensics and Security. (IF: 8.7).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/SAMamba" target="_blank">Code</a> is released.</li>
                <li>[Jun 17, 2025] One paper has been published in the IEEE Transactions on Systems, Man and Cybernetics: Systems. (IF: 8.4).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/LGA" target="_blank">Code</a> is released.</li>
                ...
                <li>[Apr 21, 2024] One paper has been published in the IEEE Transactions on Instrumentation and Measurement. (IF: 7).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/AdaptFormer" target="_blank">Code</a> is released.</li>
                <li>[Oct 20, 2023] One paper has been published in the IEEE Transactions on Medical Imaging. (IF: 12.4).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/Slim-UNETR" target="_blank">Code</a> is released.</li>
                <li>[Aug 14, 2023] One paper has been published in the IEEE Transactions on Neural Networks and Learning Systems. (IF: 10.4).</li>
                <li>[Feb 07, 2023] One paper published in the Information Sciences (IF: 8.233).</li>
          ...
          <div id="patents">
            ...
            <div className="text-sm pl-10 py-3">
              <ul className="list-disc">
                ...
                <li>内窥镜图像息肉分割方法、装置、计算机设备及存储介质，授权号: ZL202510675256.0</li>
              </ul>
            </div>
          </div>
        ...
        <div className="h-48 bg-gray-200 text-center pt-16 text-sm text-gray-500">
          ...
          <div>(Last update: July 05, 2026.)</div>
        </div>
      </div>
    </main>
  )
