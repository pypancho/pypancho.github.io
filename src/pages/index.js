      ...
      <div>
        <div className="max-w-screen-md max-w-screen-lg mx-auto px-5 py-16 md:pt-28">
          ...
          <div id="teaching">
            ...
            <div className="text-sm pl-10 py-3">
              <ul className="list-disc">
                <li>2022.09 - Present. Guangzhou University, Computer Vision(180600030-1)
                  
                    <li>                  
                      <div>
                        <a className="text-blue-600 text-sm" href={"https://github.com/pypancho/CV-Lectures"} target="_blank">Computer Vision(180600030-1),</a>
