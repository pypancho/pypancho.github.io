      ...
      <div>
        <div className="max-w-screen-md max-w-screen-lg mx-auto px-5 py-16 md:pt-28">
          ...
          <div id="news">
            ...
            <div className="text-sm pl-10 py-3">
              <ul className="list-disc">
                <li>[Jan 16, 2025] <b>NEW:</b> One paper is published in the IEEE Journal of Biomedical and Health Informatics. (IF: 6.7).  <a className="text-blue-600 text-sm" href="https://github.com/deepang-ai/MOD" target="_blank">Code</a> is released.</li>
