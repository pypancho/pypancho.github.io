      ...
      <div>
        <div className="max-w-screen-md max-w-screen-lg mx-auto px-5 py-16 md:pt-28">
          ...
          <div id="teaching">
            ...
            <div className="text-sm pl-10 py-3">
              <ul className="list-disc">
                <li>2022.09 - Present. Guangzhou University,  <div> <a className="text-blue-600 text-sm" href={"https://github.com/pypancho/CV-Lectures"} target="_blank">Computer Vision(180600030-1), </a><a className="text-blue-600 text-sm" href={"https://github.com/pypancho/NLP-Lectures"} target="_blank">Natural Language Processing(180600065-1).</a></div></li>
